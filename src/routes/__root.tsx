...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SuperMIA — AI Service Desk for Roofing Companies" },
      {
        name: "description",
        content:
          "SuperMIA answers every roofing call 24/7, books inspections, syncs your CRM, and dispatches crews — the AI service desk built for roofing operators.",
      },
      { name: "author", content: "SuperMIA" },
      { property: "og:title", content: "SuperMIA — AI Service Desk for Roofing Companies" },
      {
        property: "og:description",
        content:
          "Never miss another storm lead. SuperMIA is the AI service desk that answers, books, and dispatches for modern roofing companies.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SuperMIA — AI Service Desk for Roofing Companies" },
